...
export function ExceptionPropertiesTable({ sections, onFilterValue }: ExceptionPropertiesTableProps): JSX.Element {
    ...
    if (populatedSections.length === 0) {
        return <div className="flex h-32 items-center justify-center text-sm text-secondary">No properties</div>
    }
