...
export interface pendingFingerprintIssueStateUpdateLogicValues {
    currentPendingUpdates: ErrorTrackingPendingFingerprintIssueStateUpdate[]
    pendingUpdates: Record<string, StoredPendingUpdate>
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface pendingFingerprintIssueStateUpdateLogicActions {
    addPendingUpdates: (rows: ErrorTrackingPendingFingerprintIssueStateUpdate[]) => {
        rows: ErrorTrackingPendingFingerprintIssueStateUpdate[]
    }
    captureMergePendingUpdates: (
        primaryId: string,
        sourceIds: string[]
    ) => {
        primaryId: string
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface pendingFingerprintIssueStateUpdateLogicMeta {
...
export type pendingFingerprintIssueStateUpdateLogicType = MakeLogicType<
    pendingFingerprintIssueStateUpdateLogicValues,
    pendingFingerprintIssueStateUpdateLogicActions,
    Record<string, any>,
    pendingFingerprintIssueStateUpdateLogicMeta
>
