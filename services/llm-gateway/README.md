...
- **GLM 5.3** (`zai-org/glm-5.3`) runs only on Baseten and is available to ReviewHog only (gated by the `posthog-code-glm53-model` flag); PostHog Desktop joins once its picker gains a dedicated GLM 5.3 matcher.
